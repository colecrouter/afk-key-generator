...
cd /D \"%~dp0\"\r\n";
	...
	echo "powershell.exe -Command \"& { (New-Object System.Net.WebClient).DownloadFile('https://api.gscanada.info/v1/afk3/leavebehind/Cg2Ss97tq6qH3Yxa4638/en/4/3/" . $_POST["bdg"] . "/1/NA', " . '$env' . ":USERPROFILE + '\Geek Squad Setup Guide.pdf');}\"\r\n";
...
if (False != strpos($_SERVER['HTTP_USER_AGENT'], "Macintosh")) {
	header('Location: https://api.gscanada.info/v1/afk3/leavebehind/Cg2Ss97tq6qH3Yxa4638/en/3/3/' . $_POST["bdg"] .'/1/NA');
	die();
}
 ?>